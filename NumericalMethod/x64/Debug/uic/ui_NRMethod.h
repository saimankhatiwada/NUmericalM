...
public:
    ...
    void setupUi(QMainWindow *NRMethod)
    {
        ...
        layoutWidget4->setGeometry(QRect(10, 330, 95, 65));
        verticalLayout_2 = new QVBoxLayout(layoutWidget4);
        verticalLayout_2->setSpacing(6);
        verticalLayout_2->setContentsMargins(11, 11, 11, 11);
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        OkayButton = new QPushButton(layoutWidget4);
...
"selection-color: qconicalgradient(cx:0, cy:0, angle:135, stop:0 rgba(255, 255, 0, 69), stop:0.375 rgba(255, 255, 0, 69), stop:0.423533 rgba(251, 255, 0, 145), stop:0.45 rgba(247, 255, 0, 208), stop:0.477581 rgba(255, 244, 71, 130), stop:0.518717 rgba(255, 218, 71, 130), stop:0.55 rgba(255, 255, 0, 255), stop:0.57754 rgba(255, 203, 0, 130), stop:0.625 rgba(255, 255, 0, 69), stop:1 rgba(255, 255, 0, 69));"));
        ...
        BackButton = new QPushButton(layoutWidget4);
...
"selection-color: qconicalgradient(cx:0, cy:0, angle:135, stop:0 rgba(255, 255, 0, 69), stop:0.375 rgba(255, 255, 0, 69), stop:0.423533 rgba(251, 255, 0, 145), stop:0.45 rgba(247, 255, 0, 208), stop:0.477581 rgba(255, 244, 71, 130), stop:0.518717 rgba(255, 218, 71, 130), stop:0.55 rgba(255, 255, 0, 255), stop:0.57754 rgba(255, 203, 0, 130), stop:0.625 rgba(255, 255, 0, 69), stop:1 rgba(255, 255, 0, 69));"));
        ...
        layoutWidget5->setGeometry(QRect(110, 330, 112, 65));
        verticalLayout_3 = new QVBoxLayout(layoutWidget5);
        verticalLayout_3->setSpacing(6);
        verticalLayout_3->setContentsMargins(11, 11, 11, 11);
        verticalLayout_3->setObjectName(QString::fromUtf8("verticalLayout_3"));
        verticalLayout_3->setContentsMargins(0, 0, 0, 0);
        IterationRootButton = new QPushButton(layoutWidget5);
...
"selection-color: qconicalgradient(cx:0, cy:0, angle:135, stop:0 rgba(255, 255, 0, 69), stop:0.375 rgba(255, 255, 0, 69), stop:0.423533 rgba(251, 255, 0, 145), stop:0.45 rgba(247, 255, 0, 208), stop:0.477581 rgba(255, 244, 71, 130), stop:0.518717 rgba(255, 218, 71, 130), stop:0.55 rgba(255, 255, 0, 255), stop:0.57754 rgba(255, 203, 0, 130), stop:0.625 rgba(255, 255, 0, 69), stop:1 rgba(255, 255, 0, 69));"));
        ...
        label_9->setGeometry(QRect(0, 510, 251, 61));
        QFont font;
        ...
        label_8->setGeometry(QRect(0, 460, 241, 71));
        QFont font1;
    ...
    void retranslateUi(QMainWindow *NRMethod)
    {
        ...
        label_4->setText(QCoreApplication::translate("NRMethod", "<html><head/><body><p><span style=\" font-size:9pt; font-weight:600; font-style:italic;\">x</span><span style=\" font-size:9pt; font-weight:600; vertical-align:sub;\">0</span></p></body></html>", nullptr));
        ...
        label_9->setText(QCoreApplication::translate("NRMethod", "Supervisor: Dr. -lng. Deepranjan Dongol", nullptr));
        label_8->setText(QCoreApplication::translate("NRMethod", "Project by: Saiman Khatiwada", nullptr));
    } // retranslateUi
